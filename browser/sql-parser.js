...
if (typeof module !== 'undefined' && require.main === module) {
  ...
  // Generated by CoffeeScript 1.8.0
(function() {
  var ArgumentListValue, BetweenOp, Case, CaseBody, ExpressionList, Field, FunctionValue, Group, Having, InConditions, Join, Limit, ListValue, LiteralValue, Offset, Op, Order, OrderArgument, ParameterValue, Select, Star, StringValue, SubSelect, Table, UnaryOp, Union, Where, indent;
  ...
  exports.ExpressionList = ExpressionList = (function() {
    function ExpressionList(expressions, expression) {
    ...
    ExpressionList.prototype.toString = function() {
      console.log(this.expressions.toString && this.expressions.toString());
      return "(" + this.expressions + ", " + this.expression + ")";
    };
  ...
  exports.InConditions = InConditions = (function() {
    function InConditions(expression, conditions) {
      this.expression = expression;
      this.conditions = conditions;
      null;
    }

    InConditions.prototype.toString = function() {
      return "(" + this.expression + " IN " + this.conditions + ")";
    };
