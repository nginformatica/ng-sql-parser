...
(function() {
  ...
  grammar = {
    ...
    Expression: [
      o('CASE Expression CaseBody CaseBodies END', function() {
        return new Case($2, $3, $4);
      }), o('CASE Expression CaseBody CaseBodies ELSE Expression END', function() {
        return new Case($2, $3, $4, $6);
