  ...
  grammar = {
    ...
    SelectClause: [
      o('SELECT Top Fields FROM Table Joins', function() {
        return new Select($3, $5, false, $6, [], $2);
      }), o('SELECT Top Fields FROM Table', function() {
        return new Select($3, $5, false, [], [], $2);
      }), o('SELECT Top Fields FROM Expression', function() {
        return new Select($3, $5, false, [], [], $2);
      }), o('SELECT DISTINCT Top Fields FROM Table', function() {
        return new Select($4, $6, true, [], [], $3);
      }), o('SELECT DISTINCT Top Fields FROM Expression', function() {
        return new Select($4, $6, true, [], [], $3);
      }), o('SELECT Fields FROM Table', function() {
        return new Select($2, $4, false);
      }), o('SELECT Fields FROM Expression', function() {
        return new Select($2, $4, false);
      ...
      }), o('SELECT Fields FROM Expression Joins', function() {
        return new Select($2, $4, false, $5);
      }), o('SELECT DISTINCT Fields FROM Table Joins', function() {
        return new Select($3, $5, true, $6);
      }), o('SELECT DISTINCT Fields FROM Expression Joins', function() {
        return new Select($3, $5, true, $6);
      })
    ],
    Top: [
      o('TOP Expression', function() {
        return $2;
      })
    ],
    Table: [
    ...
    Expression: [
      o('CASE Expression CaseBodies END', function() {
        return new Case($2, $3);
      }), o('CASE Expression CaseBodies ELSE Expression END', function() {
        return new Case($2, $3, $5);
    ...
    InConditions: [
      o('ExpressionList IN ExpressionList', function() {
        return new InConditions($1, $3);
      })
    ],
    ExpressionList: [
      o('Expression', function() {
        return [$1];
      }), o('ExpressionList SEPARATOR Expression', function() {
        return new ExpressionList($1, $3);
      }), o('LEFT_PAREN ExpressionList RIGHT_PAREN', function() {
        return $2;
      })
    ],
    CaseBodies: [
      o('CaseBody'), o('CaseBodies CaseBody', function() {
        return $1.concat($2);
      })
    ],
    CaseBody: [
      o('WHEN Expression THEN Expression', function() {
        return [new CaseBody($2, $4)];
      })
    ],
    BetweenExpression: [
      o('Expression CONDITIONAL Expression', function() {
